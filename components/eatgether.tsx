...
export function Eatgether() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setZoom(14) // Zoom in when a location is found
    } catch (err) {
  ...
  const popularSpots = [
    { name: '派對房間', image: '/placeholder.svg?height=100&width=100' },
    { name: '網球聚會', image: '/placeholder.svg?height=100&width=100' },
    { name: '劇本殺', image: '/placeholder.svg?height=100&width=100' },
    { name: '桌遊咖啡廳', image: '/placeholder.svg?height=100&width=100' },
    { name: '密室逃脫', image: '/placeholder.svg?height=100&width=100' },
    { name: 'K歌之夜', image: '/placeholder.svg?height=100&width=100' },
  ]
    ...
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
      ...
      <footer className="bg-gray-800 py-8 px-4">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 mb-4 md:mb-0">&copy; 2023 Eatgether. All rights reserved.</p>
